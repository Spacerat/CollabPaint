...
*/
var jscolor={dir:"",bindClass:"color",binding:!0,preloading:!0,install:function(){jscolor.addEvent(window,"load",jscolor.init)},init:function(){jscolor.binding&&jscolor.bind();jscolor.preloading&&jscolor.preload()},getDir:function(){if(!jscolor.dir){var a=jscolor.detectDir();jscolor.dir=a!==!1?a:"jscolor/"}return jscolor.dir},detectDir:function(){for(var a=location.href,e=document.getElementsByTagName("base"),b=0;b<e.length;b+=1)if(e[b].href)a=e[b].href;e=document.getElementsByTagName("script");for(b=
0;b<e.length;b+=1)if(e[b].src&&/(^|\/)jscolor\.js([?#].*)?$/i.test(e[b].src))return a=(new jscolor.URI(e[b].src)).toAbsolute(a),a.path=a.path.replace(/[^\/]+$/,""),a.query=null,a.fragment=null,a.toString();return!1},bind:function(){for(var a=RegExp("(^|\\s)("+jscolor.bindClass+")\\s*(\\{[^}]*\\})?","i"),e=document.getElementsByTagName("input"),b=0;b<e.length;b+=1){var m;if(!e[b].color&&e[b].className&&(m=e[b].className.match(a))){if(m[3])try{eval("prop="+m[3])}catch(v){}e[b].color=new jscolor.color(e[b],
...
"//"+this.authority);this.path!==null&&(b+=this.path);this.query!==null&&(b=b+"?"+this.query);this.fragment!==null&&(b=b+"#"+this.fragment);return b};this.toAbsolute=function(b){b=new jscolor.URI(b);var a=new jscolor.URI;if(b.scheme===null)return!1;if(this.scheme!==null&&this.scheme.toLowerCase()===b.scheme.toLowerCase())this.scheme=null;this.scheme!==null?(a.scheme=this.scheme,a.authority=this.authority,a.path=e(this.path),a.query=this.query):(this.authority!==null?(a.authority=this.authority,a.path=
...
"ThreeDShadow ThreeDHighlight ThreeDHighlight ThreeDShadow";this.pickerZIndex=1E4;for(var o in e)e.hasOwnProperty(o)&&(this[o]=e[o]);this.hidePicker=function(){u()&&(delete jscolor.picker.owner,document.getElementsByTagName("body")[0].removeChild(jscolor.picker.boxB))};this.showPicker=function(){if(!u()){var b=jscolor.getElementPos(a),d=jscolor.getElementSize(a),c=jscolor.getViewPos(),e=jscolor.getViewSize(),k=[2*this.pickerBorder+4*this.pickerInset+2*this.pickerFace+jscolor.images.pad[0]+2*jscolor.images.arrow[0]+
jscolor.images.sld[0],2*this.pickerBorder+2*this.pickerInset+2*this.pickerFace+jscolor.images.pad[1]],i,f,h;switch(this.pickerPosition.toLowerCase()){case "left":i=1;f=0;h=-1;break;case "right":i=1;f=0;h=1;break;case "top":i=0;f=1;h=-1;break;default:i=0,h=f=1}var g=(d[f]+k[f])/2;b=[-c[i]+b[i]+k[i]>e[i]?-c[i]+b[i]+d[i]/2>e[i]/2&&b[i]+d[i]-k[i]>=0?b[i]+d[i]-k[i]:b[i]:b[i],-c[f]+b[f]+d[f]+k[f]-g+g*h>e[f]?-c[f]+b[f]+d[f]/2>e[f]/2&&b[f]+d[f]-g-g*h>=0?b[f]+d[f]-g-g*h:b[f]+d[f]-g+g*h:b[f]+d[f]-g+g*h>=0?
b[f]+d[f]-g+g*h:b[f]+d[f]-g-g*h];m(b[i],b[f])}};this.importColor=function(){if(h)if(this.adjust)!this.required&&/^\s*$/.test(h.value)?(h.value="",g.style.backgroundColor=g.jscStyle.backgroundColor,g.style.color=g.jscStyle.color,this.exportColor(q|y)):this.fromString(h.value)||this.exportColor();else{if(!this.fromString(h.value,q))g.style.backgroundColor=g.jscStyle.backgroundColor,g.style.color=g.jscStyle.color,this.exportColor(q|y)}else this.exportColor()};this.exportColor=function(a){if(!(a&q)&&
h){var b=this.toString();this.caps&&(b=b.toUpperCase());this.hash&&(b="#"+b);h.value=b}if(!(a&y)&&g)g.style.backgroundColor="#"+this.toString(),g.style.color=0.213*this.rgb[0]+0.715*this.rgb[1]+0.072*this.rgb[2]<0.5?"#FFF":"#000";!(a&x)&&u()&&v();!(a&w)&&u()&&B()};this.fromHSV=function(a,d,c,e){a<0&&(a=0)||a>6&&(a=6);d<0&&(d=0)||d>1&&(d=1);c<0&&(c=0)||c>1&&(c=1);this.rgb=b(a===null?this.hsv[0]:this.hsv[0]=a,d===null?this.hsv[1]:this.hsv[1]=d,c===null?this.hsv[2]:this.hsv[2]=c);this.exportColor(e)};
this.fromRGB=function(a,b,c,d){a<0&&(a=0)||a>1&&(a=1);b<0&&(b=0)||b>1&&(b=1);c<0&&(c=0)||c>1&&(c=1);a=a===null?this.rgb[0]:this.rgb[0]=a;b=b===null?this.rgb[1]:this.rgb[1]=b;var e=c===null?this.rgb[2]:this.rgb[2]=c,g=Math.min(Math.min(a,b),e);c=Math.max(Math.max(a,b),e);var f=c-g;f===0?a=[null,0,c]:(a=a===g?3+(e-b)/f:b===g?5+(a-e)/f:1+(b-a)/f,a=[a===6?0:a,f/c,c]);a[0]!==null&&(this.hsv[0]=a[0]);a[2]!==0&&(this.hsv[1]=a[1]);this.hsv[2]=a[2];this.exportColor(d)};this.fromString=function(a,b){var c=
...
(256|Math.round(255*this.rgb[2])).toString(16).substr(1)};var d=this,n=this.pickerMode.toLowerCase()==="hvs"?1:0,p=!1,h=jscolor.fetchElement(this.valueElement),g=jscolor.fetchElement(this.styleElement),s=!1,t=!1,r,q=1,y=2,x=4,w=8;jscolor.addEvent(a,"focus",function(){d.pickerOnfocus&&d.showPicker()});jscolor.addEvent(a,"blur",function(){p?p=!1:window.setTimeout(function(){p||(h===a&&d.importColor(),d.pickerOnfocus&&d.hidePicker());p=!1},0)});h&&(o=function(){d.fromString(h.value,q)},jscolor.addEvent(h,
"keyup",o),jscolor.addEvent(h,"input",o),jscolor.addEvent(h,"blur",C),h.setAttribute("autocomplete","off"));if(g)g.jscStyle={backgroundColor:g.style.backgroundColor,color:g.style.color};switch(n){case 0:jscolor.requireImage("hs.png");break;case 1:jscolor.requireImage("hv.png")}jscolor.requireImage("cross.gif");jscolor.requireImage("arrow.gif");this.importColor()}};jscolor.install();
